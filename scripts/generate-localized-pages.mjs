...
const copy = {
  es: {
    ...
    language: "Idioma",
    nav: { home: "Inicio", nurse: "Enfermería", work: "Trabajo", about: "Acerca de", editorial: "Criterios editoriales" },
    home: {
    ...
    about: {
      ...
      cards: [
        ["El desarrollador", "Paul Crapatureanu es el desarrollador independiente de My Nurse Shift Planner y My Work Shift Planner. Diseña, desarrolla, prueba y mantiene las apps y este sitio."],
    ...
    editorial: {
      ...
      description: "Cómo se redacta, revisa y actualiza el contenido de My Shift Planner, incluidas sus fuentes, cálculos y correcciones.",
      eyebrow: "Cómo creamos el contenido",
      h1: "Criterios editoriales y transparencia",
      lead: "Publicamos contenido práctico para ayudar a entender y organizar horarios por turnos. Esta página explica quién lo crea, cómo se revisa y qué límites tiene.",
      cards: [
        ["Autoría y revisión", "Paul Crapatureanu redacta o revisa cada página y comprueba las referencias a funciones con las versiones actuales de las apps. Las fechas de revisión aparecen en los artículos."],
        ["Método y fuentes", "Priorizamos documentación oficial, reglas publicadas por empleadores o autoridades y pruebas directas del producto. Evitamos presentar un patrón laboral como universal cuando varía por empresa o región."],
        ["Cálculos y límites", "Las calculadoras y estimaciones son herramientas de planificación. No incluyen automáticamente impuestos, convenios, leyes locales ni todas las políticas de nómina."],
        ["Correcciones", "Si detectas un error, escríbenos desde la página de contacto. Revisamos las correcciones y actualizamos el contenido cuando es necesario."],
        ["Relación comercial", "Este sitio presenta apps creadas por el mismo desarrollador. Indicamos claramente cuándo una página enlaza al App Store o describe funciones de pago."],
        ["Herramientas de apoyo", "Podemos utilizar herramientas de redacción, traducción o corrección. Antes de publicar, el desarrollador revisa el contenido para comprobar su precisión, claridad y adecuación al producto."]
      ]
    }
  },
  fr: {
    ...
    nav: { home: "Accueil", nurse: "Infirmier", work: "Travail", about: "À propos", editorial: "Charte éditoriale" },
    home: {
    ...
    about: { title: "À propos de My Shift Planner", description: "Découvrez le développeur de My Shift Planner, la raison d'être des apps, son expérience directe du produit et les limites du site.", eyebrow: "Qui se trouve derrière le produit", h1: "Des outils pratiques pour les horaires qui changent", lead: "My Shift Planner réunit deux apps indépendantes qui aident les personnes travaillant en horaires postés à organiser leur calendrier, leurs heures et leur rémunération estimée.", cards: [["Le développeur", "Paul Crapatureanu est le développeur indépendant de Mon Planning Infirmier et Mon Planning de Travail. Il conçoit, développe, teste et maintient les apps ainsi que ce site."], ["Pourquoi ces apps existent", "Les horaires postés s'intègrent mal aux calendriers génériques. L'objectif est d'offrir une vue personnelle et simple des rotations, nuits, différents lieux et estimations."], ["Une expérience directe du produit", "Le contenu relatif aux fonctions, aux parcours et aux calculs s'appuie sur la conception et les tests directs des apps. Les articles sont revus lorsque le produit évolue."], ["Limites importantes", "Nous ne sommes ni un service de paie, ni un employeur, ni un service médical ou juridique. Confirmez horaires officiels, paie et règles auprès des sources compétentes."]] },
    editorial: { title: "Charte éditoriale", description: "Découvrez comment le contenu de My Shift Planner est rédigé, vérifié et mis à jour, notamment ses sources, calculs et corrections.", eyebrow: "Notre méthode de publication", h1: "Charte éditoriale et transparence", lead: "Nous publions des ressources pratiques pour comprendre et organiser le travail posté. Cette page explique qui crée le contenu, comment il est vérifié et quelles sont ses limites.", cards: [["Rédaction et vérification", "Paul Crapatureanu rédige ou vérifie chaque page et compare les fonctions décrites aux versions actuelles des apps. La date de révision figure dans les articles."], ["Méthode et sources", "Nous privilégions la documentation officielle, les règles publiées par les employeurs ou autorités et les tests directs du produit. Nous ne présentons pas comme universelle une règle qui varie selon le pays ou l'entreprise."], ["Calculs et limites", "Les calculateurs et estimations servent à planifier. Ils n'intègrent pas automatiquement les impôts, conventions, lois locales ni toutes les règles de paie."], ["Corrections", "Si vous repérez une erreur, contactez-nous. Nous examinons les signalements et mettons le contenu à jour si nécessaire."], ["Lien commercial", "Ce site présente des apps créées par le même développeur. Les liens vers l'App Store et les fonctions payantes sont indiqués clairement."], ["Outils d'assistance", "Des outils de rédaction, de traduction ou de relecture peuvent être utilisés. Avant publication, le développeur vérifie la précision, la clarté et l'adéquation au produit."]] }
  },
  de: {
    lang: "de", name: "Deutsch", locale: "de_DE", siteName: "Mein Schichtplan", brandLine: "Private Planer für Schichtarbeit", language: "Sprache", nav: { home: "Start", nurse: "Pflege", work: "Arbeit", about: "Über uns", editorial: "Redaktionsrichtlinien" },
    ...
    about: { title: "Über My Shift Planner", description: "Lerne den Entwickler von My Shift Planner, den Zweck der Apps, die direkte Produkterfahrung und die Grenzen dieser Website kennen.", eyebrow: "Wer hinter dem Produkt steht", h1: "Praktische Werkzeuge für wechselnde Arbeitszeiten", lead: "My Shift Planner umfasst zwei unabhängige Apps, mit denen Menschen in Schichtarbeit ihren Kalender, ihre Stunden und Verdienstschätzungen organisieren können.", cards: [["Der Entwickler", "Paul Crapatureanu ist der unabhängige Entwickler von Mein Dienstplan Pflege und Mein Schichtplan. Er konzipiert, entwickelt, testet und pflegt die Apps und diese Website."], ["Warum es diese Apps gibt", "Schichtarbeit passt oft schlecht in allgemeine Kalender. Ziel ist eine persönliche, einfache Ansicht für Rotationen, Nachtdienste, mehrere Orte und Schätzungen."], ["Direkte Produkterfahrung", "Inhalte zu Funktionen, Abläufen und Berechnungen beruhen auf der direkten Entwicklung und Prüfung der Apps. Artikel werden bei Produktänderungen überprüft."], ["Wichtige Grenzen", "Wir sind weder Lohnabrechnungsdienst noch Arbeitgeber und bieten keine medizinische oder rechtliche Beratung. Offizielle Zeiten, Abrechnung und Regeln sind bei zuständigen Stellen zu bestätigen."]] },
    editorial: { title: "Redaktionsrichtlinien", description: "So werden Inhalte von My Shift Planner erstellt, geprüft und aktualisiert – einschließlich Quellen, Berechnungen und Korrekturen.", eyebrow: "Wie unsere Inhalte entstehen", h1: "Redaktionsrichtlinien und Transparenz", lead: "Wir veröffentlichen praktische Inhalte zum Verständnis und zur Organisation von Schichtarbeit. Hier erklären wir Autorenschaft, Prüfung und Grenzen.", cards: [["Autor und Prüfung", "Paul Crapatureanu verfasst oder prüft jede Seite und gleicht Funktionsangaben mit den aktuellen App-Versionen ab. Prüfdatum und Aktualisierung werden in Artikeln genannt."], ["Methode und Quellen", "Wir bevorzugen offizielle Dokumentation, veröffentlichte Regeln von Arbeitgebern oder Behörden und direkte Produkttests. Regional unterschiedliche Regeln stellen wir nicht als allgemeingültig dar."], ["Berechnungen und Grenzen", "Rechner und Schätzungen dienen der Planung. Steuern, Tarifverträge, lokale Gesetze und sämtliche Abrechnungsregeln werden nicht automatisch berücksichtigt."], ["Korrekturen", "Wenn du einen Fehler findest, kontaktiere uns. Wir prüfen Hinweise und aktualisieren Inhalte bei Bedarf."], ["Kommerzielle Beziehung", "Diese Website stellt Apps desselben Entwicklers vor. Links zum App Store und kostenpflichtige Funktionen werden klar gekennzeichnet."], ["Unterstützende Werkzeuge", "Werkzeuge für Textentwurf, Übersetzung oder Korrektur können unterstützen. Vor Veröffentlichung prüft der Entwickler Genauigkeit, Verständlichkeit und Produktbezug."]] }
  },
  "pt-br": {
    lang: "pt-BR", name: "Português (Brasil)", locale: "pt_BR", siteName: "Meus Turnos de Trabalho", brandLine: "Planejadores privados para escalas", language: "Idioma", nav: { home: "Início", nurse: "Enfermagem", work: "Trabalho", about: "Sobre", editorial: "Política editorial" },
    ...
    about: { title: "Sobre o My Shift Planner", description: "Conheça o desenvolvedor do My Shift Planner, o objetivo dos apps, sua experiência direta com o produto e os limites deste site.", eyebrow: "Quem está por trás do produto", h1: "Ferramentas práticas para escalas que mudam", lead: "My Shift Planner reúne dois apps independentes criados para ajudar trabalhadores em escala a organizar calendário, horas e estimativas de ganhos.", cards: [["O desenvolvedor", "Paul Crapatureanu é o desenvolvedor independente de Meus Plantões de Enfermagem e Meus Turnos de Trabalho. Ele projeta, desenvolve, testa e mantém os apps e este site."], ["Por que os apps existem", "Escalas de trabalho nem sempre funcionam bem em calendários comuns. O objetivo é oferecer uma visão pessoal e simples para rotações, noites, vários locais e estimativas."], ["Experiência direta com o produto", "O conteúdo sobre recursos, fluxos e cálculos parte da implementação e dos testes diretos dos apps. Os artigos são revisados quando o produto muda."], ["Limites importantes", "Não somos serviço de folha de pagamento, empregador nem consultoria médica ou jurídica. Horários oficiais, pagamentos e regras devem ser confirmados nas fontes responsáveis."]] },
    editorial: { title: "Política editorial", description: "Como o conteúdo do My Shift Planner é escrito, revisado e atualizado, incluindo fontes, cálculos e correções.", eyebrow: "Como produzimos o conteúdo", h1: "Política editorial e transparência", lead: "Publicamos conteúdo prático para entender e organizar o trabalho em turnos. Esta página explica autoria, revisão e limites.", cards: [["Autoria e revisão", "Paul Crapatureanu escreve ou revisa cada página e confere as referências a recursos com as versões atuais dos apps. As datas de revisão aparecem nos artigos."], ["Método e fontes", "Priorizamos documentação oficial, regras publicadas por empregadores ou autoridades e testes diretos do produto. Não tratamos como universal uma regra que varia por empresa ou região."], ["Cálculos e limites", "Calculadoras e estimativas servem ao planejamento. Elas não incluem automaticamente impostos, convenções, leis locais ou todas as regras de folha."], ["Correções", "Se encontrar um erro, entre em contato. Analisamos os relatos e atualizamos o conteúdo quando necessário."], ["Relação comercial", "Este site apresenta apps criados pelo mesmo desenvolvedor. Links para a App Store e recursos pagos são identificados com clareza."], ["Ferramentas de apoio", "Ferramentas de redação, tradução ou revisão podem ajudar. Antes da publicação, o desenvolvedor confere precisão, clareza e adequação ao produto."]] }
  },
  ja: {
    lang: "ja", name: "日本語", locale: "ja_JP", siteName: "勤務シフト管理", brandLine: "シフト勤務のための個人用プランナー", language: "言語", nav: { home: "ホーム", nurse: "看護師向け", work: "一般勤務", about: "このサイトについて", editorial: "編集方針" },
    ...
    about: { title: "My Shift Plannerについて", description: "My Shift Plannerの開発者、アプリを作った目的、製品に関する実体験、このサイトの情報範囲をご案内します。", eyebrow: "開発者と運営について", h1: "変化する勤務予定を支える実用的なツール", lead: "My Shift Plannerは、シフト勤務の方が自分の予定、勤務時間、給与見込みを整理するための2つの個人向けアプリを提供しています。", cards: [["開発者", "Paul Crapatureanuは、看護師シフト管理と勤務シフト管理を制作する個人開発者です。アプリと本サイトの設計、開発、テスト、保守を行っています。"], ["アプリを作った理由", "交代勤務は一般的なカレンダーでは管理しにくいことがあります。ローテーション、夜勤、複数の勤務地、給与見込みを分かりやすく扱える個人用ツールを目指しています。"], ["製品に関する直接的な知識", "機能、操作、計算に関する内容は、アプリの実装とテストに基づいています。製品の変更に合わせて記事を見直します。"], ["情報の範囲", "本サイトは給与計算事業者、雇用主、医療・法律相談サービスではありません。正式な勤務時間、給与、規則は勤務先や専門機関に確認してください。"]] },
    editorial: { title: "編集方針", description: "My Shift Plannerの記事をどのように作成、確認、更新しているか、情報源、計算、訂正方針を説明します。", eyebrow: "コンテンツ制作の考え方", h1: "編集方針と透明性", lead: "シフト勤務を理解し整理するための実用的な情報を公開しています。執筆者、確認方法、情報の範囲をここで説明します。", cards: [["執筆と確認", "Paul Crapatureanuが各ページを執筆または確認し、機能の説明を最新のアプリと照合します。記事には確認日を表示します。"], ["方法と情報源", "公式資料、雇用主や公的機関が公表する規則、製品の直接テストを優先します。会社や地域で異なる制度を一律のルールとして扱いません。"], ["計算と限界", "計算ツールと見込み額は計画のための目安です。税金、労働協約、地域法、すべての給与規則を自動的に反映するものではありません。"], ["訂正", "誤りを見つけた場合はお問い合わせください。内容を確認し、必要に応じて更新します。"], ["商業的な関係", "本サイトは同じ開発者が制作したアプリを紹介しています。App Storeへのリンクや有料機能について明確に表示します。"], ["補助ツール", "文章作成、翻訳、校正ツールを補助的に使用する場合があります。公開前に開発者が正確性、分かりやすさ、製品との整合性を確認します。"]] }
  }
};
...
function route(locale, type) {
  ...
  if (type === "editorial") return `${prefix}/editorial-policy/`;
  return `${prefix}/${type}/`;
}
...
console.log(`Generated ${Object.keys(copy).length * 5} localized pages.`);
